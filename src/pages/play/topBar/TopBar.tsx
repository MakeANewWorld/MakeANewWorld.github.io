...
const Top: React.FC<{ title: string, className?: string }> = ({ title, className }) => {
    ...
    return (
        <div className={className} style={{ zIndex: 1090 }}>
            <Button className="position-fixed top-0 start-0 m-3 py-1 px-2 bg-body border border-secondary"
                ref={buttonRef}
            ...
            <div ref={menuRef}
                className="position-fixed top-0 start-0 mt-5 ms-3 p-3 rounded w-50 bg-body border border-secondary"
