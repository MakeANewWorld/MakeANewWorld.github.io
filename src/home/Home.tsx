    ...
    <ThemeProvider storageKey="vite-ui-theme">
      ...
      <div className="container mx-auto px-4">
        <header className="flex flex-wrap items-center justify-center md:justify-between py-3 mb-4 border-b">
          ...
          <div className="w-full md:w-1/4 text-right">
            {helloMessage !== null ?
              <span className="font-noto">{helloMessage}</span> :
              (<>
                <a className="inline-block px-4 py-2 mr-2 text-blue-600 border border-blue-600 rounded hover:bg-blue-50" href="/user" role="button">{t("login")}</a>
      ...
      <div className="px-4 text-center">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:flex gap-2 justify-center">
            <Button href="/get-start" className="px-4 py-2 text-white bg-blue-600 rounded-md text-lg hover:bg-blue-700">{t('start')}</Button>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4">
        <footer className="flex flex-wrap justify-between items-center py-3 mt-4 border-t">
          <p className="w-full md:w-1/4 mb-0 text-gray-500 font-noto">&copy; 2025</p>
